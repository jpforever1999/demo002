...
<div id="carousel-bounding-box">
    <div id="bannerCarousel" class="carousel slide"> <div class="carousel-inner">
        <!-- main slider carousel items -->
    <?php 
    //echo "<pre>"; print_r($product_gallery); echo "</pre>";
...
<!--<div class="in-stock">
    <p><i class="fa fa-check" aria-hidden="true"></i> Ready to Ship</p>
    <p><i class="fa fa-check" aria-hidden="true"></i> In Stock </p>
    <p><i class="fa fa-check" aria-hidden="true"></i> Fast Dispatch</p>
    </div>  -->
<?php //echo "<pre>"; print_r($detail); echo "<pre>"; ?>
<div class="price">
...
<div class="row mt-4"><div class="col-md-12"><div class="tabbable-panel">
<div class="tabbable-line"> 
    <ul class="nav nav-tabs ">
        <li class="active"> <a href="#tab_default_1" data-toggle="tab">DESCRIPTION</a> </li>
        <li> <a href="#tab_default_2" data-toggle="tab"> TAGS </a></li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="tab_default_2"><ul class="tags">
            <?php  
			if(isset($tags)){
				foreach($tags as $k=>$v){
			?>
				<li class="tag-<?php echo $v->id; ?>" id="tag-<?php echo $v->id; ?>"><a href="#"><?php echo $v->name; ?></a></li>
			<?php }
			}else{
				echo '<div class="alert alert-warning">No data available!</div>';
			} ?></ul>
        ...
        <div class="tab-pane" id="tab_default_3" id="ReviewBox">
			<?php echo '<div class="alert alert-warning">No data available!</div>'; ?>
                <div class="container" id="Reviewmsg"></div>
                <div class="container" id="Reviewmessage"></div>
                <div class="container">
                    <div id="divWriteReview">
                        <form class="form-group" id="FromReview"  method="post">
                            <div class="form-group w-100 revi">
                                ...
                                <button type="submit" name="review" class="btn btn-lg btn-light">Submit</button>
                            </div>
                        </form>
                    </div>
                <hr>  
    ...
    <div class="container">
        <div class="row hp_slick">
			...
			<div id="product_id-<?php echo $v->product_id; ?>">
                <div class="white_box p-2 text-center"><a href="<?php echo get_permalink($v->post_slug); ?>" title="post title">
...
$(".term_item").click(function () {
    ...
    //console.log(JSON.stringify(variation_id_arr));
    ...
    //console.log(JSON.stringify(variation_name_arr));
...
$(".attribute").click(function () {
    ...
    console.log('uidd== '+ attrid + 'name== '+ attrname);
	//document.getElementById("attr_id").value = attrid;
	//document.getElementById("attr_name").value = attrname;
	//document.getElementById("att_id").value = varid;
	//document.getElementById("att_name").value = varid;	
