                            ...
                            <div class="col-sm-12 col-md-12 m-t-20">
                                <div class="card">
                                    <ul class="nav nav-tabs profile-tab" role="tablist">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab" style="font-size: 14px;"> Mexican </a> </li>
                                    </ul>
...
alert('hiiiiiii');
                                    ...
                                    <div class="tab-pane fade" id="v-pills-attributes" role="tabpanel" aria-labelledby="v-pills-attributes-tab">
                                        ...
                                        <div class="form-group row" id="attr-<?php echo $kk; ?>" >
                                            ...
                                            <div class="col-sm-8">
                                                <select id="attribute_item_<?php echo $kk; ?>" name="attribute_item[]" class="form-control attribute_item" multiple>
                                            ...
                                            <div class="col-sm-2 col-md-2"><button type="button" name="remove" id="<?php echo $kk; ?>" class="btn btn-danger attr_remove">X</button></div>
                                        </div>
                                        <?php }}
                                            }
                                            ?>
                                    ...
                                    <div class="tab-pane fade container-fluid" id="v-pills-advanced" role="tabpanel" aria-labelledby="v-pills-advanced-tab">
                                        <div class="row">
                                            <?php #echo "<br><pre>"; print_r($all_vari); echo "</pre>"; exit;
                                            #print '<pre>';
                                            $attr_item_array = array();
                                            if(isset($all_vari)){
                                                foreach($all_vari as $r){
                                                    $attr_item_array[$r->attribute_id][] = $r;      
                                                }
                                            }
                                            #print_r($all_attr);print_r($attr_item_array);exit;*/
                                            if(isset($all_attr)){
                                            foreach($all_attr as $att_id => $att_name){
                                            ?>
                                            <div class="col-sm-3">
                                                <label><?= $att_name ?>:</label>
                                                <select id="variations_class" data-id="<?= $att_id ?>" name="variations_class[]" class="form-control jp variation_combo" >
                                                    <option></option>
                                                    <?php if($attr_item_array[$att_id]) { foreach($attr_item_array[$att_id] as $key=>$val){ ?>
                                        ...
                                        <div id="variations_data">
                                            <?php if(isset($all_vari_term)) : foreach($all_vari_term as $k=>$v){ 
                                                ...
                                                if($attribute_item_id){
                                                    ...
                                                    foreach($attribute_item_array as $ata){
                                                        if(isset($attributes_ids[$ata])){
                                                            $item_name_array[] = $attributes_ids[$ata];
                                                        }
                                                    }
                                            ...
                                            <div class="border p-2 sadow m-t-10" style="background: #fbfbfb;" id="variation-<?php echo $variation_id; ?>">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 col-md-2"><button type="button" name="variation-remove" data-postid="<?php echo $product_id; ?>" data-id="<?php echo $attribute_item_id; ?>" data-type="db" data-variationid="variation-<?php echo $variation_id; ?>" class="btn btn-danger btn_remove_variation p-0"  style="padding:0px 7px !important;">X</button></div>
                                                </div>
                                                <div class="row mb-2">
...
<script>
    ...
    $(document).on('click','.btn_remove_variation', function(e){
    	...
    	//alert(uid);
        if(type == 'db'){	
    	    delete_variation_post(uid,postid,variationid);
        }else{
            $('#'+ variationid).remove();
        }
    } );
    
    function delete_variation_post(id,postid,variationid)
    {
        var postData = {};
    	var csrf_name = "<?= $csrf->name; ?>";
    	var csrf_value = "<?= $csrf->hash; ?>";
